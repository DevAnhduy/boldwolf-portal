...
import ModalAboutTeamMember from '../ModalAboutTeamMember/ModalAboutTeamMember';
import './AboutTeamMember.scss';

const AboutTeamMember = ({ about, token, onDeleteAboutByType }) => {
    ...
    const onDelete = () => {
        ...
        onDeleteAboutByType({ token, data: modalDelete.id, fCallBack: onDeleteCallBack }, ABOUT_TYPE.MEMBER)
    }
    ...
    return (
        <div className="about-team-member u-page-data">
            <Heading>Thành Viên</Heading>
            ...
            <div className="content">
                <TableCommon
                    columns={columns}
                    dataSource={about && filterDataByType(about, 'Member')}
                    bordered
                    pagination={false}
            ...
            {
                visible &&
                <ModalAboutTeamMember visible={visible} handleCancel={handleCancelModal} idUpdate={idUpdate} />
            }
            <ModalConfirm
...
export default connect(mapStateToProps, { onDeleteAboutByType })(AboutTeamMember);
