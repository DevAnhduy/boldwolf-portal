...
const AboutCoreValue = ({ about, token, onDeleteAboutByType }) => {
  ...
  const onDelete = () => {
    ...
    onDeleteAboutByType(
      { token, data: modalDelete.id, fCallBack: onDeleteCallBack },
      ABOUT_TYPE.COREVALUE
    );
  };
  ...
  return (
    <div className="about-core-value u-page-data">
      ...
      <div className="content">
        <TableCommon
          columns={columns}
          dataSource={about && filterDataByType(about, "Core_value")}
          bordered
          pagination={false}
        />
      </div>
...
export default connect(mapStateToProps, { onDeleteAboutByType })(
  AboutCoreValue
);
