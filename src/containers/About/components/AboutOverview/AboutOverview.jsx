...
import ModalAboutOverview from '../ModalAboutOverview/ModalAboutOverview';
import './AboutOverview.scss';

const AboutOverview = ({ about, token, onDeleteAboutByType }) => {
    ...
    const onDelete = () => {
        ...
        onDeleteAboutByType({ token, data: modalDelete.id, fCallBack: onDeleteCallBack }, ABOUT_TYPE.OVERVIEW)
    }
    ...
    return (
        <div className="about-overview u-page-data">
            <Heading>Tổng Quan Về Chúng Tôi</Heading>
            ...
            <div className="content">
                <TableCommon
                    columns={columns}
                    dataSource={about && filterDataByType(about, 'Overview')}
                    bordered
                    pagination={false}
            ...
            {
                visible &&
                <ModalAboutOverview visible={visible} handleCancel={handleCancelModal} idUpdate={idUpdate} />
            }
            <ModalConfirm
...
export default connect(mapStateToProps, { onDeleteAboutByType })(AboutOverview);
