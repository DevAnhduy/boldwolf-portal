...
import './AdventureTeam.scss';

const AdventureTeam = ({ data, token, onDeleteAdventureByType }) => {
    ...
    const onDelete = () => {
        ...
        onDeleteAdventureByType({ token, data: modalDelete.id, fCallBack: onDeleteCallBack }, ADVENTURE_TYPE.TEAM)
    }
    ...
    return (
        <div className="team-member u-page-data">
            ...
            <div className="content">
                <TableCommon
                    columns={columns}
                    dataSource={data && filterDataByType(data, ADVENTURE_TYPE.TEAM)}
                    bordered
                    pagination={false}
                />
            </div>
            {
                visible && 
                <ModalAdventure 
                    titleModal="Ban tổ chức" 
                    type = {ADVENTURE_TYPE.TEAM} 
                    isOnlyImg = {false}
                    visible={visible} 
...
export default connect(mapStateToProps, { onDeleteAdventureByType })(AdventureTeam);
